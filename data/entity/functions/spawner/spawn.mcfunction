...
# スポーン位置計算
# 厳密には9x9x9になってない。
execute positioned ~ ~1.25 ~ rotated as @e[tag=direction_xz,limit=4] rotated as @e[tag=direction_x,sort=random,limit=1] positioned ^ ^ ^2.25 rotated as @e[tag=direction_x,sort=random,limit=1] positioned ^ ^ ^1.125 rotated as @e[tag=direction_x,sort=random,limit=1] positioned ^ ^ ^0.5625 rotated as @e[tag=direction_x,sort=random,limit=1] positioned ^ ^ ^0.28125 rotated as @e[tag=direction_y,sort=random,limit=1] positioned ^ ^ ^2.25 rotated as @e[tag=direction_y,sort=random,limit=1] positioned ^ ^ ^1.125 rotated as @e[tag=direction_y,sort=random,limit=1] positioned ^ ^ ^0.5625 rotated as @e[tag=direction_y,sort=random,limit=1] positioned ^ ^ ^0.28125 rotated as @e[tag=direction_z,sort=random,limit=1] positioned ^ ^ ^2.25 rotated as @e[tag=direction_z,sort=random,limit=1] positioned ^ ^ ^1.125 rotated as @e[tag=direction_z,sort=random,limit=1] positioned ^ ^ ^0.5625 rotated as @e[tag=direction_z,sort=random,limit=1] positioned ^ ^ ^0.28125 run summon armor_stand ~ ~ ~ {Tags:["spawn","garbage","processing"],Marker:1b,Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b,NoBasePlate:1b}
