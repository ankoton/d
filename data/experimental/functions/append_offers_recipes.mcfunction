...
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:18b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:19b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:20b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:21b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:22b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:23b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:24b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:25b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
...
# set 'sell' of the last recipe
data modify entity @s Offers.Recipes[-1].sell set from block ~ ~ ~ Items[{Slot:26b}]
# remove if recipe is unfair
execute if data entity @s Offers.Recipes[-1].sell{id:"minecraft:air"} run data remove entity @s Offers.Recipes[-1]
